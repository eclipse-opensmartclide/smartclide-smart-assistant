...
enviroment_prediction_model = api.model('EnviromentPrediction', {
    'header': fields.String(description="The prediction type identification", required=False, example="resource used"),
    'service': fields.Nested(_service_model, description="The service's information", required=False),
    'environments': fields.List(fields.Nested(_enviroment_prediction), description="The recommended service's enviroments for each user volume ranges", required=False)
}, description="The recommended environment for the service deployment")


acceptance_model = api.model('AcceptaceRequest', {
    'gherkins': fields.List(fields.String(example=gherkin_example), description="Some gherkins files", required=False),
    'bpmn': fields.String(description="An XML formatted BPMN", required=True, example=bpmn_example),
    'name': fields.String(description="The BPMN file name", required=False)
...
acceptance_prediction_model = api.model('AcceptacePrediction', {
    'recommended_gherkins': fields.List(fields.String(example=gherkin_example), description="Gherkins recommended for the given BPMN", required=False),
...
developer_prediction_model = api.model('DeveloperPrediction', {
    'header': fields.String(description="The type of changes in repository", required=False, example="new commit"),
    'repo_id': fields.String(description="The id of the repository. The usual value is the URL.", required=True, example="https://github.com/example/example"),
    'state': fields.String(description="Status", required=False, example="info"),
    'user': fields.String(description="User's nickname in repository", required=False, example="mcdave"),
    ...
    'messages': fields.List(fields.String(),description="Exmplanation of the result")
...
code_generation_templates_model = api.model('CodeGenerationRequest', {
    'bpmn_file': fields.Integer(description="File with the BPMN specification of the service creation", required=True, example=bpmn_example),
    'github_repository': fields.String(description="The URL of the repository where code will be uploaded. The smartclide's user must have acces to that repository", required=True, example="https://github.com/SmartCLIDE/example-repository"),
    'meta': fields.Raw(description="Metadata required for code generation", required=True)
